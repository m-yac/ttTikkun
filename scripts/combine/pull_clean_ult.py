...
ult_p, uhb_p = top_level / 'en_ult', top_level / 'hbo_uhb'
...
def main():
    ...
    ap.add_argument('--output', type=Path, default=top_level / 'en_ult_clean',
                    help='directory to write (default: en_ult_clean/)')
